...
import com.example.demobd.common.utils.Utilities;
...
public class ExceptionHandlerConfig {
    ...
    @ResponseBody
    public ResponseEntity<ExceptionDTO> handleCustomException(RuntimeException ex) {
        ExceptionDTO errorDTO = new ExceptionDTO(Utilities.getTimestampValue(), ex.getMessage(), null);
